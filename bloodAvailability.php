...
<head>
    ...
    <link rel="stylesheet" href="./css/indexbloodavailability.css">
...
<body style="background-image: url(./css/images/bluepatternimg.jpg);">
    ...
    <div class="topnav" id="myTopnav">
        <a href="./blood request/requestblood.html">Request Blood</a>
        <a href="#bloodavilability" class="active">Blood availability</a>
        <!-- <a href="#dashboard" class="active">DashBoard</a>
        <a href="./donors.html">Donor </a>
        <a href="./patients.html">patient</a>
      
      <a href="./donations.html">Donations</a>
      <a href="./request.html">requests
      </a> -->
    <a href="./patient/about page.html">About Us</a>

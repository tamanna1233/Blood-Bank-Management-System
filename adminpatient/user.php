...
if(isset($_POST['save'])){
    ...
    $blood_group=$_POST['blood_group'];
     ...
     $sql="INSERT INTO patient_registration (first_name, last_name, email, password, mobile,  gender, dob, blood_group) VALUES('$first_name','$last_name','$email','$password','$mobile','$gender',' $dob','$blood_group')";

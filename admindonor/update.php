...
if(isset($_POST['submit'])){
    ...
    $blood_group=$_POST['blood_group'];
     ...
     $sql="update donor_registration set first_name='$first_name',last_name='$last_name',email='$email', password='$password',mobile='$mobile',gender='$gender',dob='$dob',blood_group='$blood_group' where id=$id";
